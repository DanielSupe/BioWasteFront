...
const Tutorial = () => {
    ...
    return (
        <>
            ...
            {pass == 1 ? (<div className='max-w-[60%] bg-white rounded-lg overflow-hidden box-border p-2 absolute top-[10%] right-0'>
            ...
            {pass == 2 ? (<div className='max-w-[50%] bg-white rounded-lg overflow-hidden box-border p-2 absolute top-[20%] right-10'>
            ...
            {pass == 5 ? (<div className='max-w-[70%] md:max-w-[40%] bg-white rounded-lg overflow-hidden box-border p-2 absolute bottom-16 md:bottom-[40%] right-[20%] md:right-0'>
